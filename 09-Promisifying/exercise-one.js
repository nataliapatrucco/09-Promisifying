...
function problemA() {
  ...
  promisifiedReadFile('poem-one/stanza-01.txt').then(function exito(result) {
    blue(result);
...
function problemB() {
  ...
  // // promise version
  // ???
  promisifiedReadFile('poem-one/stanza-02.txt').then(function exito(result) {
    blue(result);
    return promisifiedReadFile('poem-one/stanza-03.txt').then(function exito(result) {
      blue(result)
    })
  })
}
function problemC() {
  ...
  promisifiedReadFile('poem-one/stanza-02.txt').then(function exito(result) {
    blue(result);
    promisifiedReadFile('poem-one/stanza-03.txt').then(function exito(res) {
      blue(res)
      console.log("done")
    })
  })
...
function problemD() {
  ...
  // promise version
  // ???
  promisifiedReadFile('poem-one/stanza-04.txt').then(function exito(result) {
    blue(result);
...
function problemE() {
  ...
  // promise version
  // ???
  promisifiedReadFile('poem-one/stanza-03.txt').then(function exito(result) {
    blue(result);
    promisifiedReadFile('poem-one/stanza-04.txt').then(function exito(res) {
      blue(res)
      console.log("done")
    })
  }).catch(function error(err) {
